...
<?php $__env->startSection('title'); ?>
    تسجيل الدخول
<?php $__env->stopSection(); ?>
<style> body{direction: inherit!important;}</style>
                                                    ...
                                                    <div class="form-group mb-0 justify-content-end">
                                                        <div class="checkbox">
                                                            <div class="custom-checkbox custom-control">
                                                                <input id="checkbox-2" data-checkboxes="mygroup" class="custom-control-input" type="checkbox" name="remember" id="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>>
                                                                <label for="checkbox-2" class="custom-control-label mt-1"><?php echo e(__('Remember Me')); ?></label>
                                                            </div>
                                                        </div>
...
<?php echo $__env->make('layouts.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ahmed\Desktop\2\resources\views/auth/login.blade.php ENDPATH**/ ?>